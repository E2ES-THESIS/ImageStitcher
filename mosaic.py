...
FilepathFirst = os.path.abspath("/home/surya/Drone-Images-Mosaicing/images/1.png")
FilepathAll = os.path.abspath("/home/surya/Drone-Images-Mosaicing/images/*.png")
...
#         print heightM, widthM, height, width        
        ...
        projectedPointsH = np.matmul(M, TestPointsHom)     
